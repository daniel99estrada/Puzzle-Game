    ...
    public bool SaveData<T>(string RelativePath, T Data, bool Encrypted)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    ReferenceLoopHandling = ReferenceLoopHandling.Ignore,  // Set ReferenceLoopHandling.Ignore option
                    PreserveReferencesHandling = PreserveReferencesHandling.Objects  // Set PreserveReferencesHandling.Objects option
                });
